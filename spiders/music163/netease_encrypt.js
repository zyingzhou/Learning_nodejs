...
function b(a, b) {
    var c = CryptoJS.enc.Utf8.parse(b)   // c为key
        , d = CryptoJS.enc.Utf8.parse("0102030405060708")     // d 为IV
        , e = CryptoJS.enc.Utf8.parse(a)    // e为原始文本加密后的文本
...
d = {"rid":"R_SO_4_1302938992","offset":"0","total":"true","limit":"20","csrf_token":""};
...
// d = {"rid":"R_SO_4_32507038","offset":"0","total":"true","limit":"20","csrf_token":""};
let neteaseEncrypt = function(d){
    var data = encrypt(JSON.stringify(d), e, f, g);
    // console.log(data);
    return data;
}


module.exports = neteaseEncrypt;
